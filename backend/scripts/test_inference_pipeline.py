...
def test_inference_pipeline():
    ...
    initial_context = InferenceContext(
        study_metadata={"patient_id": "PT001", "study_id": "ST001", "segmentation_model": "v1", "classification_model": "v1"}
    )
    ...
    initial_context_fail = InferenceContext(study_metadata={}) # Missing metadata should fail validation
